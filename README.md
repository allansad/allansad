...
약 7년간의 부검 업무를 통해 복잡한 문제의 원인을 파악하고 세부적인 데이터를 분석하며 조각난 정보를 연결하는 경험을 쌓았습니다.<br>
이러한 경험들이 소프트웨어 개발에서 문제를 디버깅하고 복잡한 시스템을 이해하는 데 많은 도움이 되고 있습니다.

최근에는 "테스트 하기 쉬운 코드가 좋은 코드다"라는 글을 읽고 큰 영감을 받아, 코드 품질 향상과 안정적인 개발을 위해 테스트 코드를 열심히 공부하고 있습니다.
